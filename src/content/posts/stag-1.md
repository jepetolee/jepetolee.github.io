...
tldr:
  - 강화학습 기반 자동 트레이딩 프로젝트 STAG의 기획 배경을 정리한다.
  - 이전 프로젝트(Cryptonalytics) 실패 원인을 상향식 설계와 TDD 부재로 진단한다.
  - 기술적 지표는 가격의 직접 예측 수단이 될 수 없다는 결론에 도달한다.
prerequisites:
  - 강화학습과 마르코프 결정 과정에 대한 기본 이해
  - 파이썬과 PyTorch에 대한 친숙함
---
